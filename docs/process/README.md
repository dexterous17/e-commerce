# Process guides (chat-style walkthroughs)

Short, conversational explainers that walk through how this repo is meant to be run and shipped. Each file is standalone; read them in any order.
