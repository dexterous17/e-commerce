#!/usr/bin/env bash
# Open an SSH tunnel to Adminer running on the Lightsail server.
#
# Usage:
...
LOCAL_PORT="${ADMINER_LOCAL_PORT:-8888}"

echo "==> Opening tunnel: localhost:${LOCAL_PORT} -> ${LIGHTSAIL_HOST}:8888"
